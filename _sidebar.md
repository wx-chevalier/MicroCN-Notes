  ...
  - 2 服务化架构
    - 2.1 服务治理
      - 2.1.1 微服务治理
        - [2.1.1.1 分布式应用治理](/服务化架构/服务治理/微服务治理/分布式应用治理.md)
        - [2.1.1.2 微服务设计模式](/服务化架构/服务治理/微服务治理/微服务设计模式.md)
      - 2.1.2 微服务特征
        - [2.1.2.1 单体架构到分布式应用](/服务化架构/服务治理/微服务特征/单体架构到分布式应用.md)
      - 2.1.3 微服务拆分
        - [2.1.3.1 服务拆分与边界](/服务化架构/服务治理/微服务拆分/服务拆分与边界.md)
        - [2.1.3.2 组件化与服务化](/服务化架构/服务治理/微服务拆分/组件化与服务化.md)
    - [2.2 架构变迁](/服务化架构/架构变迁/README.md)
      - [2.2.1 SOA](/服务化架构/架构变迁/SOA.md)
      - [2.2.2 云原生](/服务化架构/架构变迁/云原生.md)
      - [2.2.3 单体架构](/服务化架构/架构变迁/单体架构.md)
      - [2.2.4 微服务](/服务化架构/架构变迁/微服务.md)
    - [2.3 服务基础](/服务化架构/服务基础/README.md)
      - [2.3.1 中间件](/服务化架构/服务基础/中间件.md)
  ...
  - [3 微服务通信](/微服务通信/README.md)
    - [3.1 N + 1 查询](/微服务通信/N%20+%201%20查询/README.md)
      
    - [3.2 RPC](/微服务通信/RPC/README.md)
      - [3.2.1 RPC 安全性](/微服务通信/RPC/RPC%20安全性.md)
      - [3.2.2 RPC 应用](/微服务通信/RPC/RPC%20应用.md)
      - [3.2.3 RPC 简史](/微服务通信/RPC/RPC%20简史.md)
      - [3.2.4 性能对比](/微服务通信/RPC/性能对比.md)
      - [3.2.5 服务发现](/微服务通信/RPC/服务发现/README.md)
        
      - [3.2.6 服务调用](/微服务通信/RPC/服务调用/README.md)
        
    - [3.3 分布式追踪](/微服务通信/分布式追踪/README.md)
      - [3.3.1 OpenTelemetry](/微服务通信/分布式追踪/OpenTelemetry/README.md)
        
      - [3.3.2 OpenTracing](/微服务通信/分布式追踪/OpenTracing/README.md)
        
      - 3.3.3 系统设计
        - [3.3.3.1 框架对比](/微服务通信/分布式追踪/系统设计/框架对比.md)
        - [3.3.3.2 系统设计](/微服务通信/分布式追踪/系统设计/系统设计.md)
    - [3.4 协议编码](/微服务通信/协议编码/README.md)
      - [3.4.1 Avro](/微服务通信/协议编码/Avro/README.md)
        - [3.4.1.1 Java](/微服务通信/协议编码/Avro/Java.md)
        - [3.4.1.2 模式演变](/微服务通信/协议编码/Avro/模式演变.md)
      - [3.4.2 Json](/微服务通信/协议编码/Json/README.md)
        - [3.4.2.1 JSONSchema](/微服务通信/协议编码/Json/JSONSchema.md)
        - [3.4.2.2 二进制编码](/微服务通信/协议编码/Json/二进制编码.md)
      - [3.4.3 Protobuf](/微服务通信/协议编码/Protobuf/README.md)
        - [3.4.3.1 快速开始](/微服务通信/协议编码/Protobuf/快速开始.md)
        - [3.4.3.2 类型定义](/微服务通信/协议编码/Protobuf/类型定义.md)
      - [3.4.4 Thrift](/微服务通信/协议编码/Thrift/README.md)
        
    - [3.5 发布订阅](/微服务通信/发布订阅/README.md)
      
    - [3.6 消息传递](/微服务通信/消息传递/README.md)
      - [3.6.1 数据流的类型](/微服务通信/消息传递/数据流的类型.md)
    - [3.7 消息队列](/微服务通信/消息队列/README.md)
  ...
  - 4 微服务框架
    ...
    - 4.8 框架对比
      - [4.8.1 微服务框架比较](/微服务框架/框架对比/微服务框架比较.md)
